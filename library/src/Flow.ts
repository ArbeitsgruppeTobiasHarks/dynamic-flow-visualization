...
export class Flow {
    ...
    static fromJson(json: any) {
        const inflow = json["inflow"].map((inflows: any) => mapValues(inflows, (rightConstant: any) => RightConstant.fromJson(rightConstant)))
        const outflow = json["outflow"].map((outflows: any) => mapValues(outflows, (rightConstant: any) => RightConstant.fromJson(rightConstant)))
