...
const App = () => {
  ...
  return (
    <MyContainer onDrop={onDrop} onDragOver={onDragOver} onDragLeave={() => setDragOver(false)}>
      ...
      <Navbar>
        ...
        <NavbarGroup align={Alignment.RIGHT}>
          <ButtonGroup>
            <Button icon="folder-shared" intent="primary" onClick={() => fileInputRef.current?.click()}>
              Open Dynamic Flow
            </Button>
